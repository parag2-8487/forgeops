...
- [ ] 1. Establish the repository boundary, licences, environment baseline, and durable records
  ...
  - [ ] 1.7 Create the initial root `PROGRESS.md`
  ...
  - [ ] 1.8 Test the repository-boundary safeguards
...
- [ ] 2. Establish backend packaging and independent core primitives
  - [ ] 2.1 Define the exact backend package metadata and dependency source of truth
  ...
  - [ ] 2.2 Add reproducible runtime and development lock workflows
  ...
  - [ ] 2.3 Implement strict project configuration loading without ambient-environment false positives
  ...
  - [ ] 2.4 Implement structured logging and RFC 9457 problem primitives
  ...
  - [ ] 2.5 Implement backend W3C Trace Context primitives and middleware
  ...
  - [ ] 2.6 Implement the engine-neutral task seam, SSE vocabulary, and core middleware
  ...
  - [ ] 2.7 Run backend-core unit tests
...
- [ ] 3. Build independent Go primitives before any application composition
  - [ ] 3.1 Initialize the Go 1.26 module and structural package boundary
  ...
  - [ ] 3.2 Implement the typed Go configuration loader
  ...
  - [ ] 3.3 Implement Go structured logging and redaction
  ...
  - [ ] 3.4 Implement Go trace propagation and the telemetry seam
  ...
  - [ ] 3.5 Implement atomic file operations, path guards, backups, and unified diffs
  ...
  - [ ] 3.6 Implement the real fsnotify watcher seam
  ...
  - [ ] 3.7 Exercise self-update signature verification without implementing auto-update
  ...
  - [ ] 3.8 Write property test P-08 for atomic change sets
  ...
  - [ ] 3.9 Write cross-runtime property test P-13 for trace context
  ...
  - [ ] 3.10 Write cross-runtime property test P-15 for configuration strictness
  ...
  - [ ] 3.11 Run Go primitive tests and module-boundary checks
...
- [ ] 4. Add only the default data-plane services and gateway policy
  - [ ] 4.1 Create the initial Compose data plane
  ...
  - [ ] 4.2 Implement the Phase 0 OPA gateway policy
  ...
  - [ ] 4.3 Validate the staged data plane and policy
...
- [ ] 5. Implement backend persistence, initial schema, health semantics, and container
  - [ ] 5.1 Implement async database/session primitives
  ...
  - [ ] 5.2 Implement the three Phase 0 SQLModel tables
  ...
  - [ ] 5.3 Configure Alembic and write the only Phase 0 migration
  ...
  - [ ] 5.4 Test the initial schema against PostgreSQL
  ...
  - [ ] 5.5 Implement the backend app factory, non-destructive lifespan, and probes
  ...
  - [ ] 5.6 Test lifespan and health during dependency loss and recovery
  ...
  - [ ] 5.7 Containerize the backend and add its default Compose service
...
- [ ] 6. Implement the accessible frontend shell, client contracts, and container
  - [ ] 6.1 Scaffold the exact frontend package and build configuration
  ...
  - [ ] 6.2 Implement shadcn primitives, providers, UI state, and the form standard
  ...
  - [ ] 6.3 Implement the RFC 9457-aware API client and public environment contract
  ...
  - [ ] 6.4 Build the shell with one real accessible Home link
  ...
  - [ ] 6.5 Write property test P-14 for frontend error normalization
  ...
  - [ ] 6.6 Run frontend unit and accessibility tests
  ...
  - [ ] 6.7 Add Playwright shell coverage and a k6 health smoke script
  ...
  - [ ] 6.8 Containerize the frontend and add its default Compose service
  ...
  - [ ] 6.9 Test frontend build-time URL inlining
...
- [ ] 7. Complete fresh-clone default Compose behavior only after both app services exist
  - [ ] 7.1 Add readiness polling and wire `make up` without changing direct Compose behavior
  ...
  - [ ] 7.2 Test exact fresh-clone default service topology
  ...
  - [ ] 7.3 Test default-profile liveness/readiness outage semantics
...
- [ ] 8. Add Go transports and probes after primitives and before concrete integration packages
  - [ ] 8.1 Implement JSON-RPC envelopes and the real coder/websocket transport
  ...
  - [ ] 8.2 Implement read-only Docker and Kubernetes doctor probes
  ...
  - [ ] 8.3 Run transport and probe tests
...
- [ ] 9. Implement the OpenTofu runner and only then add the tools profile
  - [ ] 9.1 Implement the runner contract, bounded execution, and output streaming
  ...
  - [ ] 9.2 Implement platform-specific process-tree termination
  ...
  - [ ] 9.3 Implement isolated OpenTofu child environments
  ...
  - [ ] 9.4 Implement `Validate` and `Plan` with fake-binary and unit coverage
  ...
  - [ ] 9.5 Add the exact provider fixture, six-platform lock, shared sample, devtools image, and tools profile
  ...
  - [ ] 9.6 Run real OpenTofu and lock-integrity integration tests
  ...
  - [ ] 9.7 Write property test P-12 for environment isolation
...
- [ ] 10. Implement the Git and PR client after shared Go primitives
  - [ ] 10.1 Define the Git/PR contracts and token seam
  ...
  - [ ] 10.2 Implement local branch, stage, commit, and push operations
  ...
  - [ ] 10.3 Implement PR creation, status retrieval, and bounded polling
  ...
  - [ ] 10.4 Run the complete GitOps flow tests
...
- [ ] 11. Implement the Go MCP server after OpenTofu and file operations exist
  - [ ] 11.1 Build the server and shared handler middleware
  ...
  - [ ] 11.2 Register only the three non-mutating Phase 0 tools
  ...
  - [ ] 11.3 Test the Go MCP protocol surface
...
- [ ] 12. Implement the backend MCP gateway with separate security-ordered list and call paths
  - [ ] 12.1 Implement registry loading, header routing, and OIDC verification
  ...
  - [ ] 12.2 Implement Redis-authoritative tool-list TTL caching
  ...
  - [ ] 12.3 Implement OPA policy, upstream transport, and side-effect-free metadata resolution
  ...
  - [ ] 12.4 Implement the Redis Tasks Extension state machine
  ...
  - [ ] 12.5 Implement MCP Apps sandbox hosting
  ...
  - [ ] 12.6 Implement the Python MCP server template
  ...
  - [ ] 12.7 Implement and wire the `tools/list` gateway path
  ...
  - [ ] 12.8 Implement and wire the `tools/call` gateway path
  ...
  - [ ] 12.9 Write property test P-05 for gateway routing and zero upstream work
  ...
  - [ ] 12.10 Write property and real-Redis integration coverage for P-06
  ...
  - [ ] 12.11 Write stateful/concurrent property test P-10
  ...
  - [ ] 12.12 Run end-to-end MCP gateway tests
...
- [ ] 13. Implement executable model routing, semantic cache, BYO keys, and fail-closed per-caller admission
  - [ ] 13.1 Implement six-tier configuration and endpoint descriptor validation
  ...
  - [ ] 13.2 Implement `ModelEndpoint`, `EndpointRegistry`, and production `OpenAICompatibleEndpoint`
  ...
  - [ ] 13.3 Implement the per-endpoint circuit breaker registry
  ...
  - [ ] 13.4 Implement the tiered semantic cache and recoverable index setup
  ...
  - [ ] 13.5 Implement BYO-key resolvers and only then add the vault profile
  ...
  - [ ] 13.6 Implement the Redis/Lua atomic token bucket
  ...
  - [ ] 13.7 Implement the concrete fallback router
  ...
  - [ ] 13.8 Wire model routes with the fixed security/admission order
  ...
  - [ ] 13.9 Run deterministic endpoint/cascade integration tests
  ...
  - [ ] 13.10 Write stateful property test P-01 for the circuit breaker
  ...
  - [ ] 13.11 Write property test P-02 for registry-backed cascade termination and order
  ...
  - [ ] 13.12 Write property test P-03 for zero invocation of skipped endpoints
  ...
  - [ ] 13.13 Write property test P-04 for semantic-cache precedence and resilience
  ...
  - [ ] 13.14 Test the limiter against a real Redis under concurrency and failures
  ...
  - [ ] 13.15 Test the optional vault profile separately
...
- [ ] 14. Implement the validation pipeline and deterministic Semantic Plan Analyzer
  - [ ] 14.1 Implement plan parsing, syntax/schema stages, and the stage-agnostic pipeline runner
  ...
  - [ ] 14.2 Implement deterministic destructive-action and blast-radius analysis
  ...
  - [ ] 14.3 Implement and wire the approval seam
  ...
  - [ ] 14.4 Expose plan analysis and test the real shared sample
  ...
  - [ ] 14.5 Write property test P-11 for analyzer monotonicity
...
- [ ] 15. Compose the final Go application, build/release automation, and evidence records
  - [ ] 15.1 Implement final `internal/app` composition and graceful shutdown after all constructors exist
  ...
  - [ ] 15.2 Implement final Cobra commands, doctor composition, and thin `main.go`
  ...
  - [ ] 15.3 Write property test P-07 for shutdown ordering
  ...
  - [ ] 15.4 Complete the Go dependency-exercise matrix and boundary checks
  ...
  - [ ] 15.5 Complete and audit `agent/NOTICE`
  ...
  - [ ] 15.6 Complete all root Makefile contracts
  ...
  - [ ] 15.7 Implement CI with lock, scope, and fresh-clone gates
  ...
  - [ ] 15.8 Implement reproducible release, SBOM, signing, provenance, and verification configuration
  ...
  - [ ] 15.9 Write property test P-09 across the final backend route set
  ...
  - [ ] 15.10 Verify all Phase 0 completion criteria using only earlier implementation
  ...
  - [ ] 15.11 Finalize documentation and `PROGRESS.md` from captured evidence
