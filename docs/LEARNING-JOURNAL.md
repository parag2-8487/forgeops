...
|                             |  Leaves |
| :-------------------------- | ------: |
| `done`, with cited evidence |  **58** |
| `blocked`                   |       0 |
| `pending`                   |     108 |
| **Total**                   | **166** |

`PROGRESS.md` is the authority for this table. It is verified mechanically after every leaf by
`scripts/_state.sh`, which reports `done 58`, `pending 108`, `TOTAL 166` over the Phase 1 section
