...
The application publishes **102 operations across 84 paths**.
...
| `POST` | `/api/v1/projects/{project_id}/docker/images/actions` | Pull or remove one image (through the chokepoint) | principal |
