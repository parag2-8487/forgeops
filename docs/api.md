...
The application publishes **49 operations across 41 paths**.
...
| Method | Path | Summary | Auth |
| --- | --- | --- | --- |
| `GET` | `/api/v1/analysis/codebase/chunks/{chunk_id}` | Get Chunk Details | principal |
| `GET` | `/api/v1/analysis/codebase/status` | Get Codebase Status | principal |
| `GET` | `/api/v1/analysis/codebase/symbols` | Query Symbols | principal |
