...
import uuid
from src.approvals.schemas import ChangeSetResponse, ApprovalStatus
...
class ApprovalService:
    ...
    def get_changeset(self, cs_id: str) -> Optional[ChangeSetResponse]:
        return self._store.get(cs_id)

    def list_changesets(self, project_id: Optional[str] = None) -> List[ChangeSetResponse]:
        if project_id:
