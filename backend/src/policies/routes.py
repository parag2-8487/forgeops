...
from .schemas import PolicyCreate, PolicyUpdate, PolicyRead, PolicyTemplateRead, DryRunInput
...
async def get_bundle_service(
    ...
    agent_policies_dir = Path(settings.agent_policies_dir) if hasattr(settings, "agent_policies_dir") else Path("policies/agent")
